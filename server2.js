...
app.post('/send_save', function(req, res) {
    ...
    txt.forEach(function(value){
        ...
        var posWord = value.posWord;
        console.log(posWord);
         var targetWord = value.targetWord;
        console.log(targetWord);
        var semantic = value.semantic;
        console.log(semantic);

         fs.appendFileSync('C:\\Users\\shashank\\Documents\\wsd\\wsd\\src\\main\\resources\\message.txt',value.posWord);
        fs.appendFileSync('C:\\Users\\shashank\\Documents\\wsd\\wsd\\src\\main\\resources\\message.txt',"::::::");
        fs.appendFileSync('C:\\Users\\shashank\\Documents\\wsd\\wsd\\src\\main\\resources\\message.txt',value.targetWord);
        fs.appendFileSync('C:\\Users\\shashank\\Documents\\wsd\\wsd\\src\\main\\resources\\message.txt',"::::::");
        fs.appendFileSync('C:\\Users\\shashank\\Documents\\wsd\\wsd\\src\\main\\resources\\message.txt',value.semantic);
        fs.appendFileSync('C:\\Users\\shashank\\Documents\\wsd\\wsd\\src\\main\\resources\\message.txt',"----------------------------");
    });
